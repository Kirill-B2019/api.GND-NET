        ...
        <div class="container mt-5">
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <h2>Описание</h2>
                    <p>
                        Блокчейн Ганимед представляет собой распределенную платформу на базе технологии блокчейн, предназначенную для обеспечения высокой безопасности и эффективности в обработке транзакций и управления цифровыми активами. Эта технология использует принцип децентрализации для создания неприкасаемой и прозрачной системы, которая обеспечивает безопасность данных и операций пользователей.
                    </p>
                </div>
            </div>
